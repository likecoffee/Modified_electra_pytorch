...
def main():
    ...
    parser.add_argument("--vocab_path", default="./prev_trained_model/electra_base/vocab.txt", type=str)
    parser.add_argument("--output_dir", default="./output", type=str)

    parser.add_argument('--data_name', default='electra', type=str)
    parser.add_argument('--max_ngram', default=3, type=int)
    parser.add_argument("--do_data", default=True, action='store_false')
    parser.add_argument("--do_split", default=True, action='store_false')
    ...
    # split big file
    if args.do_split:
        corpus_path = "dataset/corpus/corpus.txt"
        split_save_path = "dataset/corpus/train/"
