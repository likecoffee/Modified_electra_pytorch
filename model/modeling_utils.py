...
def temperature_sampling(logits, temperature):
    ...
    probs_detached = probs.detach().view(probs.size(0)*probs.size(1),-1) 
    pred_ids = probs_detached.multinomial(1,replacement=False)
    pred_ids = pred_ids.view(probs.size(0), probs.size(1))
    return pred_ids
